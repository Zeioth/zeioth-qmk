...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+-----------------+-----------|
      KC_LSFT,    KC_Z,    KC_X,    KC_M,    KC_C,    KC_V,                         KC_K,    KC_L, KC_COMM,  KC_DOT, CKC_QMA,            KC_RSFT,\
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+-----------------+-----------|
  ...
  //|--------+--------+-------------------+----------------+--------------+---------|                    |-------+----------------+--------------+------------------+--------+---------|
      KC_LSFT, I3_GAPS,          I3_RESIZE,         I3_MOVE,       I3_SPAD,  I3_LYM,                     I3_BARS,       I3_WINTAB,       XXXXXXX,           XXXXXXX, I3_RESET, KC_RSFT,\
  //|--------+--------+-------------------+----------------+--------------+-----------------|  |---------+-------+----------------+--------------+------------------+--------+---------|
  ...
  //,--------------------------------------------------------------.                   ,--------------------------------------------------------------------.
    ...
    //|--------+----------+---------+----------+-----------+---------|                   |--------+----------+-------------+----------+----------+------------|
        KC_LSFT, CKC_LESS,  CKC_MORE, CKC_O_PAR,  CKC_C_PAR, CKC_AND,                     CKC_OR, CKC_C_CUR,    CKC_O_CUR, CKC_C_BRK, CKC_O_BRK,  KC_LSHIFT,\
    //|--------+----------+---------+----------+-----------+---------+--------|  |-------+--------+----------+-------------+----------+----------+------------|
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LCTL, VIM_CIT,   VIM_CIP, VIM_CIS, VIM_CIW, VIM_CIB,                      KC_LEFT, KC_DOWN,  KC_UP, KC_RIGHT, XXXXXXX, KC_NO,\
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LSFT, VIM_VIT,   VIM_VIP, VIM_VIS, VIM_VIW, VIM_VIB,                     XXXXXXX, VIM_GMD,  VIM_GMU, VIM_GTD, VIM_GTU, KC_RSFT,\
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
  ...
  //|--------+---------------+------------+-------------------+-------------+--------|                    |--------+-----------+-----------+-----------+--------+--------|
    KC_LSHIFT,          KC_F4,       KC_F3,              KC_F2,        KC_F1,   KC_F5,                      KC_F10,       KC_F6,      KC_F7,      KC_F8,   KC_F9, KC_LSFT,\
  //|--------+---------------+------------+-------------------+-------------+--------+--------|  |--------+--------+-----------+-----------+-----------+--------+--------|
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  switch (keycode) {
    ...
    case CKC_BSPC: // BACKSPACE AND DEL 
      ...
      return false;
    case CKC_TAB: // TAB and ARROW MODE
      if (record->event.pressed) {
        if ((get_mods() & MOD_BIT(KC_LSHIFT))){layer_on(_ARROW);}
        else {press_virtual_key(KC_TAB, KC_TAB, 0, 0, 0, 0);}
      }
      else {clear_keyboard_but_mods();}
      return false;
